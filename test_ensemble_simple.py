#!/usr/bin/env python3
"""
Simple Ensemble Engine Test - Only Working Engines
"""
...
def test_ensemble_simple():
    """Test ensemble engine with only working engines"""
    
    print("🚀 Testing Ensemble Engine (Simple - Working Engines Only)")
    print("=" * 70)
    ...
    with app.app_context():
        try:
            ...
            if projects:
                ...
                # Test with only unified engine (known to work)
                test_payload = {
                    "title": project.title,
                    ...
                    "engines": ["unified"],  # Only use unified engine
                    "ensemble_method": "weighted_voting"
                }
                
                print(f"\n📤 Testing ensemble engine with unified engine only...")
            ...
            print(f"\n{'='*70}")
            print("🎯 Simple Ensemble Engine Testing Complete!")
            print("\n💡 What we tested:")
            print("1. ✅ Project-specific recommendations with real project data")
            print("2. ✅ General recommendations without project context")
            print("3. ✅ Ensemble scoring and engine voting transparency")
            print("4. ✅ Direct engine testing (no authentication issues)")
            
            print("\n🚀 Next steps:")
            print("1. Fix remaining engine imports (smart, enhanced)")
            print("2. Integrate ensemble engine into your frontend")
            print("3. Add engine selection options in the UI")
            print("4. Display ensemble scores and engine votes to users")
