...
from utils.recommendation_config import RecommendationConfig as Config
...
class RecommendationExplainer:
    ...
    def explain_recommendation(self, recommendation: Dict, query_context: Dict, 
                              score_components: Dict = None, user_id: int = None) -> Dict:
        """
        ...
        try:
            ...
            why_recommended = self._generate_why_recommended(
                recommendation, query_context, breakdown, user_id=user_id
            )
    ...
    def _generate_why_recommended(self, recommendation: Dict, 
                                  query_context: Dict, breakdown: Dict, user_id: int = None) -> str:
...
Your explanation:"""
            ...
            explanation = get_gemini_response(prompt, user_id=user_id)
