#!/usr/bin/env python3
"""
Simple Performance Diagnostic for Fuze Recommendation System
...
class SimplePerformanceDiagnostic:
    def __init__(self):
        self.results = {}
    ...
    def run_full_diagnostic(self):
        ...
        # Save results
        with open('simple_performance_diagnostic_results.json', 'w') as f:
            json.dump(self.results, f, indent=2, default=str)
        
        self.log("📊 Results saved to simple_performance_diagnostic_results.json")
...
def main():
    ...
    with app.app_context():
        diagnostic = SimplePerformanceDiagnostic()
