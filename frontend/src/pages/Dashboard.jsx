      ...
      <div className="relative z-10">
        ...
        <div className="w-full pt-32">
          ...
          <main className="p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto">
            ...
            {/* Welcome Section */}
            <div className="mt-8 mb-8 bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-gray-800 shadow-2xl">
              ...
              <p className="text-gray-300 text-lg md:text-xl">Here's what's happening with your bookmarks and projects.</p>
            </div>
