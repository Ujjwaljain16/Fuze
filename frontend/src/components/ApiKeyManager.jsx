...
const ApiKeyManager = () => {
  ...
  return (
    <div className={`bg-gray-900/50 backdrop-blur-sm border rounded-lg p-6 ${apiKeyRequired ? 'ring-2 ring-cyan-500/50 border-cyan-500/50' : 'border-gray-800'}`}>
      {apiKeyRequired && (
        <div className="mb-6 p-4 bg-cyan-500/10 border border-cyan-500/20 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="text-cyan-400 font-semibold mb-1">API Key Setup Required</h4>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className={`p-2 rounded-lg ${apiKeyRequired ? 'bg-cyan-500/20' : 'bg-cyan-500/20'}`}>
      ...
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
          />
        </div>
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex-1 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors flex items-center justify-center space-x-2"
          >
            {loading ? (
              <>
          ...
          <div className="mt-4 p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs text-gray-300">
                <p className="font-medium text-cyan-400 mb-1">Why use your own key?</p>
